        ...
        <div className="w-full md:w-1/2 p-4">
          <div className="bg-white p-4">
            <h2 className="text-extra-large font-bold">
              Earn <span className="text-[#6837cf]">$Fruit</span> Staking
              Rewards 💸
            </h2>
            <p className="my-2 text-normal mt-4">
              Stake your $Seed tokens and earn rewards! Empowering the
              Future with Sharded PoS Blockchain
            </p>
            <button
              className="bg-[darkblue] text-white rounded px-4 py-2 mt-4"
          ...
          <div className="bg-white p-4">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <div className="text-center">
                <div className="bg-[blueviolet] text-white p-4">
