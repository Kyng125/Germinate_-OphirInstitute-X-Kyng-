...
const StakingForm = () => {
  ...
  const contractAddress = "0x3bf87216ef8d57a5ee0e86f5ee791027f299d9a1";
  // store staking contract address
  const stakingContractAddress = "0x82996037c676bb4479a155f5103d4c0926567eb5";
        ...
        <div className="w-full md:w-1/2">
          <form className="bg-white rounded px-4 md:px-8 pt-6 pb-8 mb-4 shadow-md mx-2 md:mx-auto">
            <h2 className="text-extra-large font-bold my-4 text-center">
              Stake <span className="text-[#6837cf] mt-4">$Seed</span>
            </h2>
            <div className="mb-4">
              <label
              ...
              <input
                ...
                id="amount"
                type="number"
                placeholder="Enter amount to stake ($Seed)"
            ...
            <div className="flex items-center justify-center">
              {approvalStatus === "approved" ? (
                <button
                  className="bg-[blueviolet] text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
                  type="button"
                  onClick={stakeToken}
                >
